...
@section('interior')
	<div class="block-header block-header-default">
		<div>
			...
			<p><small>Здесь вы можете увидеть заявки от образовательных учреждений (без деталей - специальностей и предлагаемых
					количеств практикантов).<br />
					Для просмотра специальностей заявки, количеств предлагаемых практикантов - перейдите по действию &laquo;Ответы на
					заявку&raquo;. В ответах на заявку вы также можете скорректировать количество практикантов, которых вы готовы
					принять.</small></p>
		</div>
	</div>
