...
@section('form.fields')
	@php
		$fields = [['name' => 'status', 'type' => 'hidden', 'value' => \App\Models\ActiveStatus::NEW->value], ['name' => 'start', 'title' => 'Дата поступления', 'required' => true, 'type' => 'date'], ['name' => 'finish', 'title' => 'Дата завершения', 'required' => false, 'type' => 'date'], ['title' => 'Образовательное учреждение', 'type' => 'heading'], ['name' => 'school_id', 'title' => 'Образовательное учреждение', 'required' => false, 'type' => 'select', 'options' => $schools, 'placeholder' => 'Выберите образовательное учреждение'], ['name' => 'new_school', 'title' => 'Новое образовательное учреждение (нет в списке)', 'required' => false, 'type' => 'text'], ['title' => 'Специальность', 'type' => 'heading'], ['name' => 'specialty_id', 'title' => 'Специальность', 'required' => false, 'type' => 'select', 'options' => $specialties, 'placeholder' => 'Выберите специальность'], ['name' => 'new_specialty', 'title' => 'Новая специальность (нет в списке)', 'required' => false, 'type' => 'text']];
	@endphp
@endsection
