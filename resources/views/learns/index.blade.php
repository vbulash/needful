...
@section('steps')
	@php
		$steps = [['title' => 'Учащийся', 'active' => false, 'context' => 'student', 'link' => route('students.index', ['sid' => session()->getId()])], ['title' => 'История обучения', 'active' => true, 'context' => 'learn']];
	@endphp
@endsection
...
@section('interior')
	<div class="block-header block-header-default">
		<div>
			<a href="{{ route('learns.create', ['sid' => session()->getId()]) }}" class="btn btn-primary mt-3 mb-3">Добавить запись
				истории обучения</a>
	...
	<div class="block-content p-4">
		@if ($count > 0)
			<div class="table-responsive">
				<table class="table table-bordered table-hover text-nowrap" id="learns_table" style="width: 100%;">
					<thead>
						<tr>
