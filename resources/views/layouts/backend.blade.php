...
@section('body')
	<div id="page-container"
		 class="sidebar-o enable-page-overlay side-scroll page-header-fixed main-content-narrow page-header-dark sidebar-dark side-trans-enabled">
					...
					<form class="w-100" action="/" method="POST">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control border-0"
								   placeholder="Поиск или нажмите клавишу ESC.." id="page-header-search-input"
