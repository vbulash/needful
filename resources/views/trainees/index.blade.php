...
@section('steps')
	@php
		$steps = [
			['title' => 'Стажировка', 'active' => false, 'context' => 'history', 'link' => route('history.index', ['sid' => session()->getId()])],
			['title' => 'Практиканты', 'active' => true, 'context' => 'trainee'],
		];
	@endphp
@endsection
...
@section('interior')
	...
	<div class="block-content p-4">
		<div class="table-responsive">
			<table class="table table-bordered table-hover text-nowrap" id="trainees_table"
				   style="width: 100%;">
				<thead>
				<tr>
