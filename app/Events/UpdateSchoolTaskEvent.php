...
class UpdateSchoolTaskEvent extends TaskEvent {
	...
	public function __construct(School $school) {
		parent::__construct(
		title: 'Анкета образовательного учреждения проверена',
		description: "Анкета образовательного учреждения &laquo;{$school->getTitle()}&raquo; проверена. Администратор установил данной анкете статус &laquo;Актуальная&raquo;.<br/>" .
